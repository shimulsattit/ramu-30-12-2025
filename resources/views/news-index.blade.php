...
@section('title', 'News and Events - ' . (\App\Models\HeaderSetting::first()?->site_name ?? 'Barishal Cantonment Public School & College'))
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-9">
                            <div class="card-body p-4">
                                ...
                                <a href="{{ route('news.show', $news->slug) }}" class="btn btn-sm"
        ...
        @else
            <div class="card shadow-sm border-0">
                <div class="card-body p-5 text-center">
                    ...
                    <p class="text-muted">No news events available at the moment.</p>
                </div>
            </div>
        @endif
    </div>
